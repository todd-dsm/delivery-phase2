...
# EXEC: ./build-ami.sh base-debian debian-jessie.json
set -x
...
declare amiName="$1"
declare packerFile="$2"
declare statusCount='0'
declare defsValBld="-var myAWSRegion=$AWS_REGION -var amiName=$amiName $packerFile"
